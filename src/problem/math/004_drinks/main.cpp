...
// Basically P_pi = i and P !- i tell us two swap two elements in order
// If n is odd then we cant swap all elements, so return -1
void solve() {
  ll n{};
  cin >> n;
  ...
  cout << setprecision(14) << (a / n * 100) << endl;
}
